...
CREATE TABLE workflow_schedules (
    ...
    CONSTRAINT workflow_schedules_inputs_check CHECK ((jsonb_typeof(inputs) = 'object'::text)),
    CONSTRAINT workflow_schedules_parameter_signature_check CHECK ((parameter_signature ~ '^[a-f0-9]{64}$'::text)),
