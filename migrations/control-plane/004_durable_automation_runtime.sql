...
BEGIN
  INSERT INTO agent_definitions (
    ...
    (target_workspace_id, 'agent-cluster-triage', 'Kubernetes Diagnostics',
     ...
     '["acornops-target-agent"]', '["events.search","inventory.resources.list","logs.summarize","metrics.query"]',
  ...
  INSERT INTO workflow_definitions (
    ...
    (target_workspace_id, 'cluster-triage', 1, 'system', 'cluster-triage', 'Cluster triage',
     ...
     '[{"id":"collect-cluster-signals","title":"Collect cluster signals","requiredInputs":["targetId"],"agentIds":["agent-cluster-triage"],"targetBinding":{"type":"selected_target","targetType":"kubernetes","inputName":"targetId"},"enabledSkills":["acornops-observability","acornops-target-boundary-design"],"allowedMcpServers":["acornops-target-agent"],"allowedTools":["inventory.resources.list","events.search","logs.summarize","metrics.query"],"contextGrants":["workspace_metadata","target_inventory"],"approvalRequired":false}]',
