...
const INTEGRATION_LINK_PATH = '/integrations/external-chat/link';
...
export async function createExternalIntegrationLink(input: ExternalIntegrationIdentityInput): Promise<ExternalIntegrationLinkCreateResult> {
...
export async function completeExternalIntegrationLink(token: string, user: User): Promise<boolean> {
