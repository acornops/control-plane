...
workflowsRouter.get('/workspaces/:workspaceId/workflow-webhooks', requireUser, authed(workflowWebhooksController.listWorkspaceWorkflowWebhooks));
...
workflowsRouter.post('/workflow-webhooks/:webhookId/events', workflowWebhooksController.receiveWorkflowWebhook);
workflowsRouter.patch('/workflow-webhooks/:webhookId', requireUser, authed(workflowWebhooksController.updateWorkflowWebhook));
workflowsRouter.delete('/workflow-webhooks/:webhookId', requireUser, authed(workflowWebhooksController.deleteWorkflowWebhook));
workflowsRouter.post('/workflow-webhooks/:webhookId/rotate-secret', requireUser, authed(workflowWebhooksController.rotateWorkflowWebhookSigningSecret));
