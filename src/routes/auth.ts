...
import { authenticatedHandler, requireActor, requireExternalIntegrationServiceToken } from '../auth/middleware.js';
...
authRouter.post('/auth/chat/integration/link/complete', requireActor(['user']), authed(externalIntegrationLinkController.completeExternalIntegrationLinkRequest));
