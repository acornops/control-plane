...
for (const audience of ['public', 'admin']) {
  ...
  const lineLimit = audience === 'admin' ? 3450 : 27000;
...
if (combinedLineCount > 29800) {
  throw new Error(`Combined generated OpenAPI has ${combinedLineCount} lines; expected at most 29800`);
}
