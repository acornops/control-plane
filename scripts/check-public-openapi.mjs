...
for (const audience of ['public', 'admin']) {
  ...
  const lineLimit = audience === 'admin' ? 4200 : 28700;
...
if (combinedLineCount > 32900) {
  throw new Error(`Combined generated OpenAPI has ${combinedLineCount} lines; expected at most 32900`);
}
