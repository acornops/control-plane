...
for (const audience of ['public', 'admin']) {
  ...
  const lineLimit = audience === 'admin' ? 3200 : 27000;
...
if (combinedLineCount > 30200) {
  throw new Error(`Combined generated OpenAPI has ${combinedLineCount} lines; expected at most 30200`);
}
