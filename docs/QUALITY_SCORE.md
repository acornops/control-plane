...
| Workflow activity reads | 4/5 | Stable pagination, workspace isolation, grouped issue summaries, safe provenance, and focused Postgres tests | The console currently uses bounded polling rather than an event-driven workspace feed |
