...
approval-gated Workflows, follow aggregate execution and coordination state, decide
...
- Add exact link/client session and execution provenance plus pinned Workflow snapshots.
...
- Publish sanitized workspace-readable execution DTOs and durable replayable
  aggregate SSE without restoring the former step-index execution model.
